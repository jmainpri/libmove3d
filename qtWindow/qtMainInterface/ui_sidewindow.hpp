...
**
** Created: Wed Jan 6 15:21:29 2010
...
public:
    ...
    void setupUi(QWidget *SideWindow)
    {
        ...
        PRMTab->setGeometry(QRect(0, 0, 96, 26));
        ...
        DiffTab->setGeometry(QRect(0, 0, 96, 26));
        ...
        groupBoxGeneralCostSpace->setGeometry(QRect(20, 40, 401, 91));
        ...
        isCostSpaceCopy->setGeometry(QRect(20, 10, 141, 23));
        groupBoxTRRT = new QGroupBox(Cost);
        groupBoxTRRT->setObjectName(QString::fromUtf8("groupBoxTRRT"));
        groupBoxTRRT->setGeometry(QRect(20, 150, 401, 171));
        ...
        pushButtonGridInGraph = new QPushButton(Cost);
        pushButtonGridInGraph->setObjectName(QString::fromUtf8("pushButtonGridInGraph"));
        pushButtonGridInGraph->setGeometry(QRect(20, 410, 131, 32));
        pushButtonAStar = new QPushButton(Cost);
        pushButtonAStar->setObjectName(QString::fromUtf8("pushButtonAStar"));
        pushButtonAStar->setGeometry(QRect(160, 410, 131, 32));
        Tabs->addTab(Cost, QString());
        HRI = new QWidget();
        HRI->setObjectName(QString::fromUtf8("HRI"));
        scrollArea = new QScrollArea(HRI);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setGeometry(QRect(10, 10, 421, 721));
        scrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
        scrollArea->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 402, 717));
        groupBoxHri = new QGroupBox(scrollAreaWidgetContents);
        groupBoxHri->setObjectName(QString::fromUtf8("groupBoxHri"));
        groupBoxHri->setGeometry(QRect(10, 30, 391, 751));
        ...
        groupBox_6->setGeometry(QRect(10, 90, 361, 111));
        ...
        HRICSPlanner->setGeometry(QRect(10, 210, 361, 291));
        ...
        pushButtonHRICSRRT->setGeometry(QRect(20, 230, 113, 32));
        ...
        checkBoxInverseKinematics->setGeometry(QRect(140, 230, 151, 21));
        ...
        checkBoxHRIGoalBiased->setGeometry(QRect(140, 260, 101, 21));
        ...
        pushButtonResetRandPoints->setGeometry(QRect(20, 190, 141, 32));
        HRITaskSpace = new QGroupBox(groupBoxHri);
        HRITaskSpace->setObjectName(QString::fromUtf8("HRITaskSpace"));
        HRITaskSpace->setGeometry(QRect(10, 500, 361, 181));
    ...
    void retranslateUi(QWidget *SideWindow)
    {
        ...
        Tabs->setTabText(Tabs->indexOf(HRI), QApplication::translate("SideWindow", "HRI", 0, QApplication::UnicodeUTF8));

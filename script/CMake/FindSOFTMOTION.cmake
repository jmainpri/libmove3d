...
find_path (SOFTMOTION_INCLUDE_DIR softMotion/softMotion.h
  PATHS /usr/local/include /usr/include /sw/include /opt/local/include ${CMAKE_CURRENT_SOURCE_DIR}/other_libraries/softMotion/build/install/include $ENV{ROBOTPKG_BASE}/include
  )
...
find_library (SOFTMOTION_LIBRARIES softMotion
  PATHS /usr/local/lib /usr/lib /lib /sw/lib /opt/local/lib ${CMAKE_CURRENT_SOURCE_DIR}/other_libraries/softMotion/build/install/lib  $ENV{ROBOTPKG_BASE}/lib
  )

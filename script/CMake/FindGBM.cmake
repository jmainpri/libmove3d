...
find_path (GBM_INCLUDE_DIR gbM/gb.h
  PATHS /usr/local/include /usr/include /sw/include /opt/local/include ${CMAKE_CURRENT_SOURCE_DIR}/other_libraries/gbM/build/install/include $ENV{ROBOTPKG_BASE}/include
  )
...
find_library (GBM_LIBRARIES gb
  PATHS /usr/local/lib /usr/lib /lib /sw/lib /opt/local/lib ${CMAKE_CURRENT_SOURCE_DIR}/other_libraries/gbM/build/install/lib $ENV{ROBOTPKG_BASE}/lib
  )

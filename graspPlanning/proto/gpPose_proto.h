...
extern int gpFind_poses_on_object(p3d_obj *object, p3d_obj *support, std::list<gpPose> &poseListIn, double translationStep, unsigned int nbDirections, std::list<gpPose> &poseListOut);

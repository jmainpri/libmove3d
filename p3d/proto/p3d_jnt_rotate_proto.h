...
extern p3d_jnt * p3d_jnt_rotate_create ( p3d_matrix4 pos, double * v, double * vmin, double * vmax, double * vmin_rand, double * vmax_rand, double * velocity_max, double * torque_max, double * param );
extern p3d_jnt * p3d_jnt_rotate_create_deg ( p3d_matrix4 pos, double * v, double * vmin, double * vmax, double * vmin_rand, double * vmax_rand, double * velocity_max, double * torque_max, double * param );

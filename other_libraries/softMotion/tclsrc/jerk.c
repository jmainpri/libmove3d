...
double adjustTimeSlowingVc(jerkParams* limits, jerkConditions* IC, jerkConditions* FC, jerkTimesAdjusted *jerkTimesAdjusted)
{
  ...
  GoalDist =  FC->X - IC->X;
   ...
   sm_AdjustTimeSlowingVelocityWithAcc(V0, Vf, A0, Af, GoalDist, Limits, jerkTimesAdjusted->timp, &T, &dir_a, &dir_b);

  jerkTimesAdjusted->t1 = T.Tjpa;
  jerkTimesAdjusted->t2 = T.Taca;
  jerkTimesAdjusted->t3 = T.Tjna;
  jerkTimesAdjusted->t4 = T.Tvc;
  jerkTimesAdjusted->t5 = T.Tjnb;
  jerkTimesAdjusted->t6 = T.Tacb;
  jerkTimesAdjusted->t7 = T.Tjpb;

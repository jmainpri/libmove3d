...
*/
int copyReducedMat(MatO,rowsX,colsX,MatD)
	dmat MatO;
	int rowsX,
	  colsX;
	dmat MatD;
...
int fillVC2Mat(Vector_C,Mat_A,n)
	dmat Vector_C;
	dmat Mat_A;
	int n;
{
...
int fillVR2Mat(Vector_R,Mat_A,n)
	dmat Vector_R;
	dmat Mat_A;
	int n;
{
...
int matCopyNRR (A, RSLT, NORR, TOL)
    dmat      A,
              RSLT;
    int       NORR;
    double    TOL;

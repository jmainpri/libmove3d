...
extern int p3d_optim_traj_softMotion(p3d_traj *trajPt, bool param_write_file, double *gain, int *ntest, std::vector <int> lp, std::vector < std::vector <double> > positions, int *nbPositions);

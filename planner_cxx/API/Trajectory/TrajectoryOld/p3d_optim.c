...
int p3d_optim_traj(p3d_traj *trajPt, double *gain, int *ntest) {
	...
	*gain = 0.0;
	...
	opt_pathPt[0] = p3d_local_planner(robotPt, p3d_copy_config(robotPt, qinit), p3d_copy_config(robotPt, q1));
	p3d_copy_iksol(robotPt->cntrt_manager, localpath1Pt->ikSol, &((opt_pathPt[0])->ikSol));
	opt_pathPt[1] = p3d_local_planner(robotPt, p3d_copy_config(robotPt, q1), p3d_copy_config(robotPt, q2));
	p3d_copy_iksol(robotPt->cntrt_manager, localpath1Pt->ikSol, &((opt_pathPt[1])->ikSol));
	opt_pathPt[2] = p3d_local_planner(robotPt, p3d_copy_config(robotPt, q2), p3d_copy_config(robotPt, qgoal));

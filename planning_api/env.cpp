...
Env::Env()
{
  ...
  mDoubleMap.insert(doubleMap_t(Env::zone_size, new doubleContainer(150.0)));
  mDoubleMap.insert(doubleMap_t(Env::coeffPen, new doubleContainer(50.0)));
  mDoubleMap.insert(doubleMap_t(Env::coeffDis, new doubleContainer(20.0)));
  ...
  mBoolMap.insert(boolMap_t(Env::notUseHriDis, new boolContainer(false)));
  mBoolMap.insert(boolMap_t(Env::notUseHriPen, new boolContainer(false)));
  mBoolMap.insert(boolMap_t(Env::enable, new boolContainer(false)));

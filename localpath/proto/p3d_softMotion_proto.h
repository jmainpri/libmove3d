...
extern void p3d_softMotion_write_curve_for_bltplot(p3d_rob* robotPt, p3d_traj* traj, char* fileName, bool flagPlot, std::vector <int> &lp, std::vector < std::vector <double> > &positions);

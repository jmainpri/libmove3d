...
extern p3d_localpath *p3d_multiLocalPath_localplanner(p3d_rob *robotPt, int multiLocalPathID, p3d_softMotion_data** softMotion_data, configPt qi, configPt qf, configPt qfp1, int* ikSol);

...
extern int psp_srch_model_pt ( p3d_rob* r, p3d_rob* objRob, int numpoints, hri_bitmapset* PSP_BTSET );
extern int psp_srch_model_pt_obj ( p3d_rob* r, p3d_obj* object, int numpoints, double viewPercent, hri_bitmapset* PSP_BTSET );
...
extern int psp_srch_model_pt_searchball ( psp_searchball *sball, p3d_rob* r, int numpoints, hri_bitmapset* PSP_BTSET );
extern int psp_rnd_srch_model_pt ( p3d_rob* r, p3d_rob* objRob, int numpoints, hri_bitmapset* PSP_BTSET );
extern void psr_get_obj_list ( void );
...
extern int psp_srch_for_target_obj ( p3d_rob *robot, int numPoints, int searchMode, hri_bitmapset* PSP_BTSET );

...
/* #define JIDO  Change this definition to JIDO, HRP2 or BH if you use these robots */
...
static gsl_vector * AlphaProj = NULL;
...
int hri_gik_compute(p3d_rob * robot, hri_gik * gik, int step, double reach, int direct, double force,
		    p3d_vector3* goalCoord, p3d_vector3* goalOrient, configPt * qresult, int (*fct)(void))

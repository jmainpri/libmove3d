...
extern int p3d_convert_traj_to_softMotion(p3d_traj *trajPt, bool param_write_file, bool approximate, std::vector <int> &lp, std::vector < std::vector <double> > &positions, SM_TRAJ &smTraj);

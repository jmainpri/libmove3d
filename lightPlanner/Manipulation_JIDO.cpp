#if defined(CXX_PLANNER) && defined(MULTILOCALPATH) && defined(GRASP_PLANNING) && defined(LIGHT_PLANNER)
...
int Manipulation_JIDO::armPlanGoto(int lp[], Gb_q6 positions[],  int *nbPositions){
